...
def incluir_relacao():
    ...
    formula = FormulaDao.incluir_relacao(formula)

    return jsonify(formula.serialize()) if formula.codigo_liminar else None


    #AJEITAR ERRO DE CONLITO DESSE JEITO AQUI
    # if determinacao:
    #    return jsonify(determinacao.serialize())
    #else:
    #    return "Conflict", 409

    #ALSO BAD REQUEST 403
